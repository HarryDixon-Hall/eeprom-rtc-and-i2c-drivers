...
# 24 "./eeprom.h"
typedef struct {
    unsigned char temp_lower;
    unsigned char temp_upper;
    unsigned char htime_upper;
    unsigned char alarm_hour;
    unsigned char alarm_minute;
    unsigned char alarm_enabled;
    unsigned char alarm_tone;
    unsigned char heating_enabled;
} SystemConfig;
...
void eeprom_write_byte(unsigned char addr, unsigned char value, void (*cb)(unsigned char status)) {
    ...
    i2c_request_t req = {
        ...
        .len = 1,
        .rw = 0,
        .callback = eeprom_write_callback
    };
    I2C1_Submit(&req);
}
